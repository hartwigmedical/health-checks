...
public class InsertSizeMetricsReport extends BaseReport {
    ...
    public InsertSizeMetricsReport(final CheckType checkType, final List<BaseDataReport> referenceSample,
