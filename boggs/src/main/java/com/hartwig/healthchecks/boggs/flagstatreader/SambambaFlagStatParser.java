...
public class SambambaFlagStatParser implements FlagStatParser {
    ...
    private static final int MATE_MAPPED_DIF_CHR_Q5_INDEX = 12;
    private static final int MATE_MAPPED_DIF_CHR_INDEX = 11;
    ...
    private FlagStats buildFlagStatsData(@NotNull final Double[] data) {
        return new FlagStatsBuilder().setTotal(data[TOTAL_INDEX]).setSecondary(data[SECONDARY_INDEX])
                ...
                .setMateMappedToDifferentChr(data[MATE_MAPPED_DIF_CHR_INDEX])
                .setMateMappedToDifferentChrMapQ5(data[MATE_MAPPED_DIF_CHR_Q5_INDEX]).build();
    }
}