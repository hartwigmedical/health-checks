...
public class SomaticExtractorTest {
    ...
    public void setUp() {
        ...
        missingHeaderLines = Collections.singletonList(HEADER_NOT_RIGHT);
    }
    ...
    private static void assertPatientReport(@NotNull final List<BaseDataReport> patientData,
            @NotNull final String checkName, @NotNull final String expectedValue) {
        final Optional<BaseDataReport> report = patientData.stream().filter(
